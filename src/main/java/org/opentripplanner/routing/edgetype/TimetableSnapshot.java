...
import org.opentripplanner.updater.stoptime.AddedTripPatternIndex;
...
public class TimetableSnapshot {
    ...
    private AddedTripPatternIndex addedTripPatternIndex = new AddedTripPatternIndex();
    ...
    public TripPattern getLastAddedTripPattern(String feedId, String tripId, ServiceDate serviceDate) {
        return addedTripPatternIndex.getLastAddedTripPattern(feedId, tripId, serviceDate);
    }
    ...
    public boolean update(String feedId, TripPattern pattern, TripTimes updatedTripTimes, ServiceDate serviceDate) {
        ...
        if (tripIndex == -1) {
            ...
            addedTripPatternIndex.addTripPattern(feedId, tripId, serviceDate, pattern);
        } else {
    ...
    public TimetableSnapshot commit(boolean force) {
        ...
        ret.addedTripPatternIndex = this.addedTripPatternIndex.copy();
    ...
    protected boolean clearLastAddedTripPattern(String feedId) {
       return addedTripPatternIndex.clearTripPattern(feedId);
    }
    ...
    public boolean purgeExpiredData(ServiceDate serviceDate) {
        ...
        modified |= addedTripPatternIndex.purgeExpiredData(serviceDate);
    ...
    public Collection<TripPattern> getTripPatternsForStop(Stop stop) {
        return addedTripPatternIndex.getTripPatternsForStop(stop);
    }
