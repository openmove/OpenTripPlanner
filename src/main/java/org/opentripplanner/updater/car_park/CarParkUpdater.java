            ...
            for (CarPark carPark : carParks) {
                ...
                if (verticesByPark.get(carPark) == null) {
                    ...
                    if (numberOfVertices == 0 ){
                        if (!(splitter.linkToClosestWalkableEdge(carParkVertex, NON_DESTRUCTIVE_SPLIT, true)
                                && splitter.linkToClosestDrivableEdge(carParkVertex, NON_DESTRUCTIVE_SPLIT, true)
                        )) {
