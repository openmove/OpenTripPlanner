...
/**
 * <p>Classe Java per AdministratorVersionedRefStructure complex type.
 * 
...
public class AdministratorVersionedRefStructure {
    ...
    public AdministratorVersionedRefStructure withCreated(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    public AdministratorVersionedRefStructure withLastUpdated(LocalDateTime value) {
